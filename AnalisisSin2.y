...
Atribucion: IDENTIFICADOR IGUAL expA PNTCOMA
	|IDENTIFICADOR CORCHETEA expA CORCHETEC IGUAL expA PNTCOMA
	 |IDENTIFICADOR IGUAL input PNTCOMA
	|IDENTIFICADOR CORCHETEA expA CORCHETEC IGUAL input PNTCOMA;

return: RETURN expA PNTCOMA;
output: OUTPUT PARENTESISA expBasica PARENTESISC PNTCOMA;
input: INPUT PARENTESISA LITERALSTRING PARENTESISC
	|INPUT PARENTESISA PARENTESISC;
